		...
		<div class="wrapper">
			<form>
				<table class="insertBox" style="width: 600px;">
					...
					<tr>
						<th>수강월</th>
						<td><input type="text" name="m_date" maxlength="6">
							2022년03월 예)202203</td>
					</tr>
					<tr>
						<th>회원명</th>
						<td><select name="m_name" onchange="fn_change1();">
					...
					<tr>
						<th>강의장소</th>
						<td><select name="c_area" onchange="fn_change2();">
					...
					<tr>
						<th>강의명</th>
						<td><select name="t_code" onchange="fn_change2();">
